...
void correct_tilt(int top_right, int bottom_right, int top_left, int bottom_left, VL6180X *left_sensor, VL6180X *right_sensor) {
  ...
  if (right_sensor->readRangeSingleMillimeters() < left_sensor->readRangeSingleMillimeters()) {
    ...
    analogWrite(MOTOR_FORWARD_PINS[top_left], 150); 
    analogWrite(MOTOR_FORWARD_PINS[top_right], 0);
    analogWrite(MOTOR_FORWARD_PINS[bottom_left], 150);
  ...
  if (left_sensor->readRangeSingleMillimeters() > right_sensor->readRangeSingleMillimeters()){
    ...
    analogWrite(MOTOR_BACKWARD_PINS[top_left], 0);
    analogWrite(MOTOR_BACKWARD_PINS[top_right], 150);  // 
    analogWrite(MOTOR_BACKWARD_PINS[bottom_left], 0);
    analogWrite(MOTOR_BACKWARD_PINS[bottom_right], 150); //
...
// NEW STRAGH FUNCTION 4/27 12pm
void straight(int rel_top_left, int rel_top_right, int rel_bottom_left, int rel_bottom_right, VL6180X *left_sensor, VL6180X *right_sensor) {
  analogWrite(MOTOR_FORWARD_PINS[rel_top_left], 200);
  analogWrite(MOTOR_FORWARD_PINS[rel_top_right], 0);
  analogWrite(MOTOR_FORWARD_PINS[rel_bottom_left], 200);
  analogWrite(MOTOR_FORWARD_PINS[rel_bottom_right], 0);

  analogWrite(MOTOR_BACKWARD_PINS[rel_top_left], 0);
  analogWrite(MOTOR_BACKWARD_PINS[rel_top_right], 200);
  analogWrite(MOTOR_BACKWARD_PINS[rel_bottom_left], 0);
  analogWrite(MOTOR_BACKWARD_PINS[rel_bottom_right], 200);
